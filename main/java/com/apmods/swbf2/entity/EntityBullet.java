...
public class EntityBullet extends EntityThrowable implements IProjectile{
	...
	public EntityBullet(World par1World) {
	   ...
	   public EntityBullet(World par1World, EntityLivingBase entity, float speed) {
	       super(par1World, entity);
	       this.shootingEntity = entity;
	       this.setThrowableHeading(motionX, motionY, motionZ, speed, damage);
	   }
	   public EntityBullet(World par1World, EntityPlayer player, float speed, float offset) {
	       super(par1World, player);
	       this.shootingEntity = player;
	       Vec3 v = player.getLookVec().normalize();
	       Vec3 vP = v.rotatePitch(90);
	       vP.rotateYaw(90);
	       damage = 0.5f;
	   ...
	   public EntityBullet(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, int par5)
	   {
	       super(par1World);
