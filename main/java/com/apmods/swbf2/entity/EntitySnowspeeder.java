...
public class EntitySnowspeeder extends Entity implements IEntityAdditionalSpawnData, IInventory
{
	public double speed;
	...
	/**
	 * 0 is flying, 1 is landed, 2 is descending and 3 is ascending
	 */
	...
	public EntitySnowspeeder(World world)
	{
		super(world);
	...
	public EntitySnowspeeder(World world, int x, int y, int z, String owner)
	{
		this(world);
	...
	public void onUpdate()
	{
		...
		int l = this.dataWatcher.getWatchableObjectInt(27);
		if(l == 1){
