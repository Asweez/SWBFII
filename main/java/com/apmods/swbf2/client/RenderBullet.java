...
public class RenderBullet extends Render
{
    ...
    public RenderBullet(ResourceLocation res, ResourceLocation tex){
     ...
     */
    protected ResourceLocation getEntityTexture(EntityBullet spell)
    {
        return new ResourceLocation(Battlefront.MODID + ":textures/entity/bullet.png");
    }
